...
//	}
	...
	public Student_Enroll_Interest(StudentVo vo) {
		...
		lec_year.setFont(new Font("맑은 고딕", Font.PLAIN, 14));
		...
		lec_semester.setFont(new Font("맑은 고딕", Font.PLAIN, 14));
		...
		lec_div.setFont(new Font("맑은 고딕", Font.PLAIN, 14));
		...
		fixed_4.setFont(new Font("맑은 고딕", Font.BOLD, 14));
		contentPane.add(fixed_4);
		
		lec_pro = new JTextField();
		lec_pro.setBounds(349, 48, 75, 30);
		lec_pro.setFont(new Font("맑은 고딕", Font.PLAIN, 14));
		...
		lec_name.setFont(new Font("맑은 고딕", Font.PLAIN, 14));
		...
		fixed_8.setFont(new Font("맑은 고딕", Font.PLAIN, 10));
