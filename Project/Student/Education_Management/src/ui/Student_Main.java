...
//	}
	...
	public Student_Main(int id_txt, String pw_txt) {
		...
		fixed_3.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 20));
		...
		stu_id.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 20));
		...
		stu_grade.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 20));
		...
		stu_college.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 16));
		...
		stu_major.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 16));
		...
		stu_enroll.setFont(new Font("¸¼Àº °íµñ", Font.PLAIN, 20));
